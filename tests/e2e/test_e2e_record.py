...
class RecordPageE2ELocalTest(unittest.TestCase):
    ...
    def test_special_case_medal_record_workflow(self):
        ...
        self.browser.find_element(
            By.XPATH, "/html/body/div[2]/div/div[6]/button[1]"
        ).click()  # click confirm button first time
        self.browser.find_element(
            By.XPATH, "/html/body/div[2]/div/div[6]/button[1]"
        ).click()  # click confirm button second time
        # change status back to trophy
        change_status_to_trophy()
    ...
    def test_impossible_medal_quantity_record_workflow(self):
        ...
        self.browser.find_element(By.XPATH, '//*[@id="input1-1"]').send_keys(
            "777777"
        )  # add gold medal to 777777
        self.browser.find_element(By.XPATH, '//*[@id="input2-2"]').send_keys(
            "0"
        )  # add silver medal to 0
        self.browser.find_element(By.XPATH, '//*[@id="input3-3"]').send_keys(
            "0"
        )  # add bronze medal to 0
        self.browser.find_element(
            By.XPATH, '//*[@id="root"]/div/div[2]/div[3]/input[2]'
        ).click()  # click record medal button
        self.browser.find_element(
    ...
    def test_invalid_countries_selection_of_record_workflow(self):
        ...
        self.browser.find_element(
            By.XPATH,
            '//*[@id="root"]/div/div[2]/div[2]/div/div[2]/div/div[2]/div/div/div[2]/div[2]',
        ).click()  # select Azerbaijan
        self.browser.find_element(
            By.XPATH,
            '//*[@id="root"]/div/div[2]/div[2]/div/div[2]/div/div[3]/div/div/div',
